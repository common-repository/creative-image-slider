...
<!-- ********************************************************FORM OPTIONS**************************************************************************************************************************************************************************************************************************************************************************************************** -->
					...
					<div class="cis_controls"><input type="text" name="name" id="cis_name" value="<?php echo $v = $id == 0 ? '' : stripslashes($row->name);?>" class="inputbox required" size="40" =""  ></div>
					...
					<div style="clear: both;margin: 15px 0 10px 0px;color: #08c; font-style: italic;font-size: 12px;text-decoration: underline;"><?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_SLIDER_OPTIONS_LABEL' ];?></div>
							...
							<div class="cis_controls">
								...
								$opts = array(
									0 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_POPUP_ZOOM'], // Open Popup onclick of Zoom icon
									1 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_POPUP_OVERLAY'], // Open Popup onclick of overlay
									2 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_POPUP_BUTTON'], // Open Popup onclick of overlay button
									3 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_POPUP_NONE'] // none
								);
								$options = array();
					...
					<div style="clear: both;height: 5px;"></div>
					<div class="cis_control_label"><label id="" for="cis_link_open_event" class="hasTooltip" title="<?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_LINK_OPENEVENT_DESCRIPTION' ];?>" ><?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_LINK_OPENEVENT_LABEL' ];?></label></div>
					<div class="cis_controls">
						<?php
						$default = $id == 0 ? $slider_global_options['link_open_event'] : $row->link_open_event;
						$opts = array(
							0 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_LINK_ZOOM'], // Open Link onclick of Link icon
							1 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_LINK_OVERLAY'], // Open Link onclick of overlay
							2 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_LINK_BUTTON'], // Open Link onclick of overlay button
							3 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_LINK_NONE'] // none
						);
						$options = array();
					...
					<div style="clear: both;height: 5px;"></div>
					<div class="cis_control_label"><label id="" for="cis_touch_enabled" class="hasTooltip" title="<?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_TOUCH_ENABLED_DESCRIPTION' ];?>" ><?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_TOUCH_ENABLED_LABEL' ];?></label></div>
					<div class="cis_controls">
						<?php
						$default = $id == 0 ? $slider_global_options['cis_touch_enabled'] : $row->cis_touch_enabled;
						$opts = array(
							0 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_TOUCH_DISABLED'], // disabled
							1 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_TOUCH_ENABLED'], // enabled
							2 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_TOUCH_MOBILE'] // only on mobile
						);
						$options = array();
					...
					<div style="clear: both;height: 5px;"></div>
					<div class="cis_control_label"><label id="" for="cis_touch_type" class="hasTooltip" title="<?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_TOUCH_TYPE_DESCRIPTION' ];?>" ><?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_TOUCH_TYPE_LABEL' ];?></label></div>
					<div class="cis_controls">
						<?php
						$default = $id == 0 ? $slider_global_options['cis_touch_type'] : $row->cis_touch_type;
						$opts = array(
							0 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_TOUCH_TYPE_1'],
							1 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_TOUCH_TYPE_2'],
							2 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_TOUCH_TYPE_3']
						);
						$options = array();
					...
					<div style="clear: both;height: 5px;"></div>
					<div class="cis_control_label"><label id="" for="cis_inf_scroll_enabled" class="hasTooltip" title="<?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_INF_SCROLL_ENABLED_DESCRIPTION' ];?>" ><?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_INF_SCROLL_ENABLED_LABEL' ];?></label></div>
					<div class="cis_controls">
						<?php
						$default = $id == 0 ? $slider_global_options['cis_inf_scroll_enabled'] : $row->cis_inf_scroll_enabled;
						$opts = array(
							0 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_INF_SCROLL_DISABLED'], // disabled
							1 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_INF_SCROLL_ENABLED'] // enabled
						);
						$options = array();
					...
					<div style="clear: both;height: 5px;"></div>
					<div class="cis_control_label"><label id="" for="cis_mouse_scroll_enabled" class="hasTooltip" title="<?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_MOUSE_SCROLL_ENABLED_DESCRIPTION' ];?>" ><?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_MOUSE_SCROLL_ENABLED_LABEL' ];?></label></div>
					<div class="cis_controls">
						<?php
						$default = $id == 0 ? $slider_global_options['cis_mouse_scroll_enabled'] : $row->cis_mouse_scroll_enabled;
						$opts = array(
							0 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_MOUSE_SCROLL_DISABLED'], // disabled
							1 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_MOUSE_SCROLL_ENABLED'] // enabled
						);
						$options = array();
					...
					<div style="clear: both;height: 5px;"></div>
					<div class="cis_control_label"><label id="" for="cis_item_correction_enabled" class="hasTooltip" title="<?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_ITEM_CORRECTION_ENABLED_DESCRIPTION' ];?>" ><?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_ITEM_CORRECTION_ENABLED_LABEL' ];?></label></div>
					<div class="cis_controls">
						<?php
						$default = $id == 0 ? $slider_global_options['cis_item_correction_enabled'] : $row->cis_item_correction_enabled;
						$opts = array(
							0 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_ITEM_CORRECTION_DISABLED'], // disabled
							1 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_ITEM_CORRECTION_ENABLED'] // enabled
						);
						$options = array();
					...
					<div style="clear: both;height: 5px;"></div>
					<div class="cis_control_label"><label id="" for="cis_animation_type" class="hasTooltip" title="<?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_ANIMATION_TYPE_DESCRIPTION' ];?>" ><?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_ANIMATION_TYPE_LABEL' ];?></label></div>
					<div class="cis_controls">
						<?php
						$default = $id == 0 ? $slider_global_options['cis_animation_type'] : $row->cis_animation_type;
						$opts = array(
							0 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_ANIMATION_TYPE_CSS'], // disabled
							1 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_ANIMATION_TYPE_JAVASCRIPT'] // enabled
						);
						$options = array();
					...
					<!-- Slider Appearance ****************************************************************************************-->
					<div style="clear: both;margin: 15px 0 10px 0px;color: #08c; font-style: italic;font-size: 12px;text-decoration: underline;"><?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_SLIDER_APPEARANCE_LABEL' ];?></div>

					<div style="clear: both;height: 5px;"></div>
					<div class="cis_control_label"><label id="" for="slider_full_width" class="hasTooltip" title="<?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_SLIDER_FULL_SIZE_DESCRIPTION' ];?>" ><?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_SLIDER_FULL_SIZE_LABEL' ];?></label></div>
					<div class="cis_controls">
						<?php
						$default = $id == 0 ? $slider_global_options['slider_full_size'] : $row->slider_full_size;
						$opts = array(
							0 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_NO'], // disabled
							1 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_YES'] // enabled
						);
						$options = array();
					...
					<div style="clear: both;height: 5px;"></div>
					<div class="cis_control_label"><label id="" for="cis_item_hover_effect" class="hasTooltip" title="<?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_ITEMS_APPEARANCE_EFFECT_DESCRIPTION' ];?>" ><?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_ITEMS_APPEARANCE_EFFECT_LABEL' ];?></label></div>
					<div class="cis_controls">
						<?php
						$default = $id == 0 ? $slider_global_options['cis_items_appearance_effect'] : $row->cis_items_appearance_effect;
						$opts = array(
							0 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_ITEMS_APPEARANCE_EFFECT_0'], // disabled
							1 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_ITEMS_APPEARANCE_EFFECT_1'] // enabled
						);
						$options = array();
					...
					<div style="clear: both;height: 5px;"></div>
					<div class="cis_control_label"><label id="" for="cis_item_hover_effect" class="hasTooltip" title="<?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_ITEMS_HOVER_EFFECT_DESCRIPTION' ];?>" ><?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_ITEMS_HOVER_EFFECT_LABEL' ];?></label></div>
					<div class="cis_controls">
						<?php
						$default = $id == 0 ? $slider_global_options['cis_item_hover_effect'] : $row->cis_item_hover_effect;
						$opts = array(
							0 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_ITEMS_HOVER_EFFECT_0'], // disabled
							1 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_ITEMS_HOVER_EFFECT_1'], // enabled
							2 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_ITEMS_HOVER_EFFECT_2'] // enabled
						);
						$options = array();
					...
					<!-- TODO -->
					<div class="cis_control_label"><label id="" for="cis_overlay_type" class="hasTooltip" title="<?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_OVERLAY_TYPE_DESCRIPTION' ];?>" ><?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_OVERLAY_TYPE_LABEL' ];?></label></div>
					<div class="cis_controls">
						<?php
						$default = $id == 0 ? $slider_global_options['cis_overlay_type'] : $row->cis_overlay_type;
						$opts = array(
							0 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_OVERLAY_TYPE_1'],
							1 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_OVERLAY_TYPE_2']
						);
						$options = array();
					...
					<div class="cis_controls">
						...
						$opts = array(
							0 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_SLIDE_UP'],
							1 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_KEEP_VISIBLE'],
							2 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_FADE'],
							3 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_FOLLOW_MOUSE'],
							4 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_HIDDEN']
						);
						$options = array();
					...
					<div style="clear: both;height: 5px;"></div>
					<div class="cis_control_label"><label id="" for="cis_ov_items_offset" class="hasTooltip" title="<?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_OV_ITEMS_OFFSET_DESCRIPTION' ];?>" ><?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_OV_ITEMS_OFFSET_LABEL' ];?></label></div>
					<div class="cis_controls cis_slider_wrapper">
						<?php
						$default = $id == 0 ? $slider_global_options['ov_items_offset'] : $row->ov_items_offset;
					...
					<div style="clear: both;height: 5px;"></div>
					<div class="cis_control_label"><label id="" for="cis_ov_items_m_offset" class="hasTooltip" title="<?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_OV_ITEMS_M_OFFSET_DESCRIPTION' ];?>" ><?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_OV_ITEMS_M_OFFSET_LABEL' ];?></label></div>
					<div class="cis_controls cis_slider_wrapper">
						<?php
						$default = $id == 0 ? $slider_global_options['ov_items_m_offset'] : $row->ov_items_m_offset;
					...
					<!-- Caption Options ****************************************************************************************-->
					<div style="clear: both;margin: 15px 0 10px 0px;color: #08c; font-style: italic;font-size: 12px;text-decoration: underline;"><?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_CAPTION_OPTIONS_LABEL' ];?></div>
					...
					<div class="cis_controls"><input type="text" name="captionmargin" id="cis_captionmargin" value="<?php echo $v = $id == 0 ? $slider_global_options['captionmargin'] : $row->captionmargin;?>" class="inputbox" size="40" required="" ></div>
					...
					<div style="clear: both;height: 5px;"></div>
					<div class="cis_control_label"><label id="" for="cis_font_family" class="hasTooltip" title="<?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_FONT_FAMILY_DESCRIPTION' ];?>" ><?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_FONT_FAMILY_LABEL' ];?></label></div>
					<div class="cis_controls">
						<?php
						$default = $id == 0 ? $slider_global_options['cis_font_family'] : $row->cis_font_family;
						$options = array();
					...
					<div style="clear: both;height: 5px;"></div>
					<div class="cis_control_label"><label id="" for="cis_font_effect" class="hasTooltip" title="<?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_FONT_EFFECT_DESCRIPTION' ];?>" ><?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_FONT_EFFECT_LABEL' ];?></label></div>
					<div class="cis_controls cis_slider_wrapper">
						<?php
						$default = $id == 0 ? $slider_global_options['cis_font_effect'] : $row->cis_font_effect;
						$options = array();
					...
					<!-- Icons Options ****************************************************************************************-->
					<div style="clear: both;margin: 15px 0 10px 0px;color: #08c; font-style: italic;font-size: 12px;text-decoration: underline;"><?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_ICON_OPTIONS_LABEL' ];?></div>

					<div style="clear: both;height: 5px;"></div>
					<div class="cis_control_label"><label id="" for="cis_icons_size" class="hasTooltip" title="<?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_ICONS_SIZE_DESCRIPTION' ];?>" ><?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_ICONS_SIZE_LABEL' ];?></label></div>
					<div class="cis_controls cis_slider_wrapper">
						<?php
						$default = $id == 0 ? $slider_global_options['icons_size'] : $row->icons_size;
					...
					<div style="clear: both;height: 5px;"></div>
					<div class="cis_control_label"><label id="" for="cis_icons_margin" class="hasTooltip" title="<?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_ICONS_MARGIN_DESCRIPTION' ];?>" ><?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_ICONS_MARGIN_LABEL' ];?></label></div>
					<div class="cis_controls cis_slider_wrapper">
						<?php
						$default = $id == 0 ? $slider_global_options['icons_margin'] : $row->icons_margin;
					...
					<div style="clear: both;height: 5px;"></div>
					<div class="cis_control_label"><label id="" for="cis_icons_offset" class="hasTooltip" title="<?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_ICONS_OFFSET_DESCRIPTION' ];?>" ><?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_ICONS_OFFSET_LABEL' ];?></label></div>
					<div class="cis_controls cis_slider_wrapper">
						<?php
						$default = $id == 0 ? $slider_global_options['icons_offset'] : $row->icons_offset;
					...
					<div style="clear: both;height: 5px;"></div>
					<div class="cis_control_label"><label id="" for="cis_icons_valign" class="hasTooltip" title="<?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_ICONS_VALIGN_DESCRIPTION' ];?>" ><?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_ICONS_VALIGN_LABEL' ];?></label></div>
					<div class="cis_controls">
						<?php
						$default = $id == 0 ? $slider_global_options['icons_valign'] : $row->icons_valign;
						$opts = array(0 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_ICON_POSITION_TOP'], 1 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_ICON_POSITION_CENTER']);
						$options = array();
					...
					<div style="clear: both;height: 5px;"></div>
					<div class="cis_control_label"><label id="" for="cis_icons_color" class="hasTooltip" title="<?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_ICONS_COLOR_DESCRIPTION' ];?>" ><?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_ICONS_COLOR_LABEL' ];?></label></div>
					<div class="cis_controls">
						<?php
						$default = $id == 0 ? $slider_global_options['icons_color'] : $row->icons_color;
						$opts = array(0 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_ICON_COLOR_BLACK'], 1 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_ICON_COLOR_WHITE']);
						$options = array();
					...
					<div style="clear: both;height: 5px;"></div>
					<div class="cis_control_label"><label id="" for="cis_icons_animation" class="hasTooltip" title="<?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_ICONS_ANIMATION_DESCRIPTION' ];?>" ><?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_ICONS_ANIMATION_LABEL' ];?></label></div>
					<div class="cis_controls">
						<?php
						$default = $id == 0 ? $slider_global_options['icons_animation'] : $row->icons_animation;
						$opts = array(0 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_ICON_ANIM_0'], 1 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_ICON_ANIM_1'], 2 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_ICON_ANIM_2'], 3 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_ICON_ANIM_3'], 4 => $slider_dictionary['COM_CREATIVEIMAGESLIDER_ICON_ANIM_NONE']);
						$options = array();
					...
					<div style="clear: both;margin: 15px 0 10px 0px;color: #08c; font-style: italic;font-size: 12px;text-decoration: underline;"><?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_CUSTOM_CODE_LABEL' ];?></div>

					<div style="clear: both;height: 5px;"></div>
					<div class="cis_control_label"><label id="" for="cis_custom_css" class="hasTooltip" title="<?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_CUSTOM_STYLES_DESCRIPTION' ];?>" ><?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_CUSTOM_STYLES_LABEL' ];?></label></div>
					<div class="cis_controls cis_slider_wrapper">
						<textarea name="custom_css" id="cis_custom_styles" style="height: 250px;width: 220px;"><?php echo stripslashes($row->custom_css);?></textarea>
					</div>

					<div style="clear: both;height: 5px;"></div>
					<div class="cis_control_label"><label id="" for="cis_custom_js" class="hasTooltip" title="<?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_CUSTOM_JS_DESCRIPTION' ];?>" ><?php echo $slider_dictionary[ 'COM_CREATIVEIMAGESLIDER_CUSTOM_JS_LABEL' ];?></label></div>
					<div class="cis_controls cis_slider_wrapper">
						<textarea name="custom_js" id="cis_custom_js" style="height: 250px; width: 220px;"><?php echo stripslashes($row->custom_js);?></textarea>
					</div>
					<!-- ******************************************************** END FORM OPTIONS**************************************************************************************************************************************************************************************************************************************************************************************************** -->
				</td>
						...
						<div id="cis_preview_wrapper1" style="position: relative;overflow: hidden;">
							<div id="cis_preview_inner1" style="padding-bottom: 32px;">
								...
								if($cis_google_fonts != '') {
									...
									echo '<link rel="stylesheet"  href="'.$cis_google_font_link.'" type="text/css" />';
								}
...
<?php
//adding a nonce
wp_nonce_field( 'slider-manage-' . $id );
?>
</form>
<?php }?>
